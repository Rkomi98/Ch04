...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7ba4458, const void *arg_0xb7ba45f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b558c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79ff840), 
int (*key_eq_fn)(void *arg_0xb79ffc88, void *arg_0xb79ffe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78ce9b8, int arg_0xb78ceb10);
static double RandomUniform(void );
...
typedef TMilli sendAckC$Timer$precision_tag;
...
static void sendAckC$Timer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$Timer$startPeriodic(uint32_t dt);
#line 78
static void sendAckC$Timer$stop(void );
# 36 "sendAckC.nc"
uint8_t sendAckC$last_digit[1000];
uint8_t sendAckC$counter[1000];
uint8_t sendAckC$i[1000];
...
static inline void sendAckC$Timer$fired(void );
...
#line 182
static inline void sendAckC$Read$readDone(error_t result, uint16_t data2);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
#line 147
{
  ...
  if (len != sizeof(my_msg_t )) {
      sim_log_error(158U, "radio_pack", "Packet malformed\n");
      return buf;
    }
  else {
      my_msg_t *mess = (my_msg_t *)payload;

      sim_log_debug(159U, "radio_rec", "Received a message at time %s\n", sim_time_string());




      if (__nesc_ntoh_uint8(mess->type.nxdata) == 1) {
          sendAckC$counter[sim_node()] = __nesc_ntoh_uint16(mess->counter.nxdata);
          for (sendAckC$i[sim_node()] = 0; sendAckC$i[sim_node()] <= sendAckC$last_digit[sim_node()]; sendAckC$i[sim_node()]++) {
              sendAckC$sendResp();
              sim_log_debug(160U, "radio", "REQ sent with counter %d and data: %hhu \n", sendAckC$counter[sim_node()], __nesc_ntoh_uint16(mess->data.nxdata));
            }
        }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7672ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7672ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7672ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb766f178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb766f178, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$Timer$startPeriodic(uint32_t dt){
#line 64
...
#line 92
{
  if (err == SUCCESS) {
      ...
      if (TOS_NODE_ID == 1) {
          sendAckC$Timer$startPeriodic(1000);
        }
    }
  else {
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7672108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7672108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb75156a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb75156a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb75156a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb782a650){
#line 75
  switch (arg_0xb782a650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb782a650);
#line 75
      break;
#line 75
    }
...
#line 54
  ...
  __nesc_hton_uint16(mess->counter.nxdata, sendAckC$counter[sim_node()]);
  ...
  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      ...
      if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(149U, "radio", "REQ sent with counter %d and data: %hhu \n", sendAckC$counter[sim_node()], __nesc_ntoh_uint16(mess->data.nxdata));
...
#line 188
  ...
  __nesc_hton_uint16(mess->counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint16(mess->data.nxdata, data2);



  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(161U, "radio_send", "RESP sent\n");
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73963a8){
#line 83
  switch (arg_0xb73963a8) {
#line 83
    case 0U:
#line 83
      sendAckC$Timer$fired();
#line 83
      break;
#line 83
    case 1U:
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73963a8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb75140a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb75140a0, addr, msg, len);
#line 80
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$Timer$stop(void ){
#line 78
...
#line 86
{
  sim_log_debug(150U, "boot", "Application booted on Mote %d\n", TOS_NODE_ID);
  sendAckC$SplitControl$start();
}
...
#line 119
{
  ...
  if (&sendAckC$packet[sim_node()] == buf) {
      ...
      if (sendAckC$PacketAcknowledgements$wasAcked(&sendAckC$packet[sim_node()])) {
          ...
          sim_log_debug_clear(156U, "radio_ack", "Packet not acknowledged \n");
        }
    }
  else {
      sim_log_error(157U, "radio_send", "Send done error!");
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$i"))
  {
    *addr = (uintptr_t)&sendAckC$i[__nesc_mote];
    *size = sizeof(sendAckC$i[__nesc_mote]);
    return 0;
  }
