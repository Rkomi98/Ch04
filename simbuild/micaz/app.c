...
#line 148
{
  ...
  if (len != sizeof(my_msg_t )) {
      sim_log_error(159U, "radio_pack", "Packet malformed\n");
      return buf;
    }
  else {
      my_msg_t *mess = (my_msg_t *)payload;

      sim_log_debug(160U, "radio_rec", "Received a message at time %s\n", sim_time_string());
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7658ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7658ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7658ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7658108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7658108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74fdca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74fdca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74fdca8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 186
  ...
  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(161U, "radio_send", "RESP sent %d, %d \n", data, sendAckC$counter[sim_node()]);
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb737b3a8){
#line 83
  switch (arg_0xb737b3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb737b3a8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74fa730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74fa730, addr, msg, len);
#line 80
...
#line 129
        if (sendAckC$PacketAcknowledgements$wasAcked(&sendAckC$packet[sim_node()]) && (sendAckC$counter[sim_node()] <= sendAckC$rec_id[sim_node()] + sendAckC$last_digit[sim_node()] + 1 && sendAckC$counter[sim_node()] > sendAckC$rec_id[sim_node()])) {
            sim_log_debug_clear(156U, "radio_ack", "Packet acknowledged \n");
          }
        else {
            sim_log_debug_clear(157U, "radio_ack", "Packet not acknowledged \n");
          }
        }
    }
  else 
